...
import (
	...
	. "github.com/cppforlife/knctl/pkg/knctl/cmd/knative"
)

func TestNewInstallCmd_Ok(t *testing.T) {
	realCmd := NewInstallOptions(nil, cmdcore.NewDepsFactory(), &cmdcore.KubeconfigFlags{})
	cmd := NewTestCmd(t, NewInstallCmd(realCmd, cmdcore.FlagsFactory{}))
